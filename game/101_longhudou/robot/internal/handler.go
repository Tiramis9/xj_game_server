...
import (
	...
	"xj_game_server/game/101_longhudou/robot/robot"
...
func handlerReqlyFail(args []interface{}) {
	_ = args[0].(*msg.Game_S_ReqlyFail)
	a := args[1].(gate.Agent)

	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 龙虎斗 请求失败=====%c[0m %v\n", 0x1B, 0x1B, "a is nil! 请求失败")
		a.Close()
		return
	}
...
func handlerLoginSuccess(args []interface{}) {
	...
	if agent.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 龙虎斗 登录失败=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		agent.Close()
		return
	}
	//
...
func handlerJettonScene(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 龙虎斗 下注场景=====%c[0m %v\n", 0x1B, 0x1B, "a is nil！")
		a.Close()
		return
	}
...
func handlerLotteryScene(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 龙虎斗 开奖场景=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		a.Close()
		return
	}
...
func handlerGameStart(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 龙虎斗 游戏开始=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		a.Close()
		return
	}
...
func handlerGameConclude(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 龙虎斗 游戏结束=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		a.Close()
		return
	}
