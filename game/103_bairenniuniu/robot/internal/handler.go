...
import (
	...
	"xj_game_server/game/103_bairenniuniu/robot/robot"
...
func handlerReqlyFail(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 百人牛牛 请求失败=====%c[0m %v\n", 0x1B, 0x1B, "a is nil! 请求失败")
		a.Close()
		return
	}
...
func handlerLoginSuccess(args []interface{}) {
	...
	if agent.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 百人牛牛 登录失败=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		agent.Close()
		return
	}
	//
...
func handlerJettonScene(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 百人牛牛 下注场景=====%c[0m %v\n", 0x1B, 0x1B, "a is nil！")
		a.Close()
		return
	}
	...
	//
	//if err != nil {
	//	_ = log.Logger.Errorf("%c[1;40;31m 百人牛牛 下注场景解析数据失败=====%c[0m  %c[1;40;34m %v  %c[0m\n", 0x1B, 0x1B, 0x1B, err, 0x1B)
	//
	//	return
	//}

	//go value.(*robot.Robot).RobotLottery(getAreaMultiple())
}
...
func handlerLotteryScene(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 百人牛牛 开奖场景=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		a.Close()
		return
	}
...
func handlerGameStart(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 百人牛牛 游戏开始=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		a.Close()
		return
	}
...
func handlerGameConclude(args []interface{}) {
	...
	if a.UserData() == nil {
		_ = log.Logger.Errorf("%c[1;40;31m 百人牛牛 游戏结束=====%c[0m %v\n", 0x1B, 0x1B, "a is nil!")
		a.Close()
		return
	}
...
func getAreaMultiple() (int32, float32) {
	...
	area := util.RandInterval(0, global.AreaCount-1)
	multiple := float32(0)
