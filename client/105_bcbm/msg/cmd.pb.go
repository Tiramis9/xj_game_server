...
type Game_S_GameConclude struct {
	...
	LotteryLocation      int32             `protobuf:"varint,4,opt,name=LotteryLocation,proto3" json:"LotteryLocation,omitempty"`
	SlowDown             float32           `protobuf:"fixed32,5,opt,name=SlowDown,proto3" json:"SlowDown,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Game_S_GameConclude) GetLotteryLocation() int32 {
	if m != nil {
		return m.LotteryLocation
	}
	return 0
}

func (m *Game_S_GameConclude) GetSlowDown() float32 {
	if m != nil {
		return m.SlowDown
	}
	return 0
...
type Game_S_JettonScene struct {
	...
	JettonList           []float32            `protobuf:"fixed32,8,rep,packed,name=JettonList,proto3" json:"JettonList,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
type Game_S_LotteryScene struct {
	...
	LotteryRecord        []int32              `protobuf:"varint,4,rep,packed,name=LotteryRecord,proto3" json:"LotteryRecord,omitempty"`
	UserArraJetton       []*Game_C_AreaJetton `protobuf:"bytes,5,rep,name=UserArraJetton,proto3" json:"UserArraJetton,omitempty"`
	LotteryPoker         int32                `protobuf:"varint,6,opt,name=LotteryPoker,proto3" json:"LotteryPoker,omitempty"`
	WinArea              []bool               `protobuf:"varint,7,rep,packed,name=WinArea,proto3" json:"WinArea,omitempty"`
	UserCount            int32                `protobuf:"varint,8,opt,name=UserCount,proto3" json:"UserCount,omitempty"`
	JettonList           []float32            `protobuf:"fixed32,9,rep,packed,name=JettonList,proto3" json:"JettonList,omitempty"`
	LotteryLocation      int32                `protobuf:"varint,10,opt,name=LotteryLocation,proto3" json:"LotteryLocation,omitempty"`
	UserJetton           []*Game_C_AreaJetton `protobuf:"bytes,11,rep,name=UserJetton,proto3" json:"UserJetton,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *Game_S_LotteryScene) GetLotteryLocation() int32 {
	if m != nil {
		return m.LotteryLocation
	}
	return 0
...
var fileDescriptor_a090769f8e2c12a2 = []byte{
	...
	,
}
